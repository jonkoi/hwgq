...
LIBRARIES += glog gflags protobuf boost_system boost_filesystem m hdf5_hl hdf5 gemmbitserial
...
CXXFLAGS += -march=native -std=c++11 -pthread -fPIC $(COMMON_FLAGS) $(WARNINGS)
